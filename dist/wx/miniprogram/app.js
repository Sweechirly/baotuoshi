...
(self["webpackChunkbaotuoshi"] = self["webpackChunkbaotuoshi"] || []).push([[0],{

/***/ 0:
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {

__webpack_require__.g.currentModuleId = "mpx-app-scope"
__webpack_require__.g.currentResource = "/Users/xinxuetao/sensetime/study/baotuoshi/src/miniprogram/app.mpx"
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_reduce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(363);
...
function makeMap(arr) {
  return _babel_runtime_corejs3_core_js_stable_instance_reduce__WEBPACK_IMPORTED_MODULE_2___default()(arr).call(arr, function (obj, item) {
    obj[item] = true;
    return obj;
  }, {});
}
...
/* harmony import */ var _mini_transform__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(524);
/* harmony import */ var _mini_promisify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(529);
...
function install(target) {
  ...
  var transedApi = (0,_mini_transform__WEBPACK_IMPORTED_MODULE_2__["default"])({
    exclude: exclude,
    from: from,
    to: to,
    custom: custom
  });
  var promisedApi = usePromise ? (0,_mini_promisify__WEBPACK_IMPORTED_MODULE_3__["default"])(transedApi, whiteList, blackList) : {};
  ...
  _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(allApi).forEach(function (api) {
    try {
  ...
  // Fallback Map option
  _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(fallbackMap).forEach(function (k) {
    if (!target[k]) {
...
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(525);
...
// canvas api 用
var CANVAS_MAP = {};
var getWxToAliApi = function getWxToAliApi() {
  return {
    /**
     * 基础
     */
    ...
    offBLEConnectionStateChange: function offBLEConnectionStateChange(callback) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(525);
...
var envObj = (0,_common_js__WEBPACK_IMPORTED_MODULE_3__.getEnvObj)();
...
function promisify(listObj, whiteList, customBlackList) {
  ...
  var fromMap = (0,_common_js__WEBPACK_IMPORTED_MODULE_3__.genFromMap)();
    ...
    result[key] = function () {
      ...
      if (promisifyFilter(key)) {
        if (!args[0] || fromMap[args[0]]) {
          args.unshift({
            success: _common_js__WEBPACK_IMPORTED_MODULE_3__.noop,
            fail: _common_js__WEBPACK_IMPORTED_MODULE_3__.noop
          });
        }
        var obj = args[0];
        var returned;
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(275);
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(525);
/* harmony import */ var _platform_wxToAli__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(526);
/* harmony import */ var _platform_wxToQq__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(527);
/* harmony import */ var _platform_wxToTt__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(528);
...
function transformApi(options) {
  ...
  var wxToAliApi = (0,_platform_wxToAli__WEBPACK_IMPORTED_MODULE_3__["default"])();
  var wxToQqApi = (0,_platform_wxToQq__WEBPACK_IMPORTED_MODULE_4__["default"])();
  var wxToTtApi = (0,_platform_wxToTt__WEBPACK_IMPORTED_MODULE_5__["default"])();
  var platformMap = {
    wx_ali: wxToAliApi,
    wx_qq: wxToQqApi,
    wx_tt: wxToTtApi
  ...
  var excludeMap = (0,_common_js__WEBPACK_IMPORTED_MODULE_2__.makeMap)(options.exclude);
  var platformApi = platformMap[fromTo] || {};
  _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context2 = _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(envObj)).call(_context2, _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(platformApi)).forEach(function (key) {
    if (!excludeMap[key]) {
      needProxy[key] = envObj[key] || platformApi[key];
    }
  });
  var result = Object.create(null);
  _babel_runtime_corejs3_core_js_stable_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(needProxy).forEach(function (api) {
    // 非函数不做转换
    ...
    result[api] = function () {
      ...
      if (options.custom[fromTo] && options.custom[fromTo][api]) {
        ...
        (0,_common_js__WEBPACK_IMPORTED_MODULE_2__.error)("\u5F53\u524D\u73AF\u5883\u4E0D\u5B58\u5728 ".concat(api, " \u65B9\u6CD5"));
      }
    };
  });
  return result;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mpxjs_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _mpxjs_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(472);
/* harmony import */ var _mpxjs_api_proxy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(523);
